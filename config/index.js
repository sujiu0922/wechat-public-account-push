...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx5defce8af2a47acc',
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '6e8bdd74fd9c946b86585130b305caa7',
  ...
  USERS: [
    {
      ...
      id: 'oADmO6QgAPwxKDcJxGmxDp2F7Y6Y',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'jXws37xAC6jcPd48CzvuM6OX6D7ov3c-CBAn8xxJ_8o',
      // 所在省份
      province: '河南',
      // 所在城市
      city: '南阳',
